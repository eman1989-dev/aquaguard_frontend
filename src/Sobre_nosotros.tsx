        ...
        {features.map((f, i) => (
          ...
          >
            <div className="flex justify-center items-center mb-4">
                <div className="w-50 h-50">{f.image}</div>
            </div>
